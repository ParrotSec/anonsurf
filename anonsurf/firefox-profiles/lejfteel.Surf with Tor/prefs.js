...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1471181493);
...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1471181613);
...
user_pref("browser.safebrowsing.provider.google.lastupdatetime", "1471181609655");
user_pref("browser.safebrowsing.provider.google.nextupdatetime", "1471183501655");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1471181337887");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1471184937887");
user_pref("browser.search.countryCode", "IT");
user_pref("browser.search.defaultenginename", "DuckDuckGo");
user_pref("browser.search.hiddenOneOffs", "Google,Yahoo,Bing,Amazon.com,Debian packages,eBay,Twitter,Wikipedia (en)");
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1471267728765");
user_pref("datareporting.healthreport.service.firstRun", true);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1471181385374");
user_pref("datareporting.policy.firstRunTime", "1471181328764");
user_pref("datareporting.sessions.current.activeTicks", 1);
user_pref("datareporting.sessions.current.clean", true);
user_pref("datareporting.sessions.current.firstPaint", 4880);
user_pref("datareporting.sessions.current.main", 1961);
user_pref("datareporting.sessions.current.sessionRestored", 3784);
user_pref("datareporting.sessions.current.startTime", "1471182343877");
user_pref("datareporting.sessions.current.totalTime", 7);
user_pref("datareporting.sessions.currentIndex", 4);
user_pref("datareporting.sessions.previous.0", "{\"s\":1471181241823,\"a\":7,\"t\":130,\"c\":true,\"m\":84381,\"fp\":91376,\"sr\":91303}");
user_pref("datareporting.sessions.previous.1", "{\"s\":1471181372889,\"a\":46,\"t\":241,\"c\":true,\"m\":22,\"fp\":2796,\"sr\":2504}");
user_pref("datareporting.sessions.previous.2", "{\"s\":1471181975529,\"a\":14,\"t\":76,\"c\":true,\"m\":3930,\"fp\":6168,\"sr\":5887}");
user_pref("datareporting.sessions.previous.3", "{\"s\":1471182230751,\"a\":12,\"t\":111,\"c\":true,\"m\":5920,\"fp\":7893,\"sr\":7734}");
...
user_pref("toolkit.startup.last_success", 1471182345);
user_pref("toolkit.telemetry.cachedClientID", "265607ab-34e0-4c7f-9121-73e1a6443800");
